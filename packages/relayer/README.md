...
4. Install PostgreSQL and create a database (or use docker!)
...
5. Run the relayer.
   ...
   2. fill in the blanks in .env.example and save it as .env

6. You should have your entire setup up and running!
