...
// This legacy template extracts a command not from the email body but from the email body.
...
template EmailAuthLegacy(n, k, max_header_bytes, max_subject_bytes, recipient_enabled) {
    ...
    component email_verifier = EmailVerifier(max_header_bytes, 0, n, k, 1, 0, 0, 0);
