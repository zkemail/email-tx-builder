...
include "./regexes/command_clicksend.circom";
...
template EmailAuthClicksend(n, k, max_header_bytes, max_body_bytes, max_command_bytes) {
    ...
    component email_verifier = EmailVerifier(max_header_bytes, max_body_bytes, n, k, 0, 0, 0, 1);
