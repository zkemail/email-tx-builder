...
import {EmailAuthSigner, EmailAuthMsg} from "../../src/EmailAuthSigner.sol";
...
contract SignerDeploymentHelper is Test {
    using ECDSA for *;
    ...
    function resetEnviromentVariables() public {
        ...
        vm.setEnv("EMAIL_AUTH_SIGNER_IMPL", vm.toString(address(0)));
